...
export default function Home() {
  return (
    <div className='sm:flex  sm:mb-44'>
       <div className=' '>
       <img src={profile} className='rounded-full  sm:mt-40 sm:mx-10 sm:ml-24 mx-11  mt-10 ' alt="" />
        ...
        <div className=' sm:mt-64 sm:ml-60 mt-10 mx-5  '>
            ...
            <p className='sm:text-xl text-sm text-white font-semibold mt-5 text-left mx-auto '> I am a passionate second-year student currently in my third semester.
